...
Func CreateSmartUpgradeGUI()
	...
	GUICtrlCreateGroup(GetTranslated(671,1, "AutoUpgrade"), $x - 20, $y - 20, 430, 335)
	$g_hChkSmartUpgrade = GUICtrlCreateCheckbox(GetTranslated(671,2, "Enable AutoUpgrade"), $x - 5, $y, -1, -1)
