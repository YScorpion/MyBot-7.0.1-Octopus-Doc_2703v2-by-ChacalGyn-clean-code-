...
Func CreateTroopsSpellsSubTab()
   ...
   Local $y = 8
	   ...
	   $g_hRdoArmy2 = GUICtrlCreateRadio(GetTranslated(621, 38, "Army 12"), $x + 180, $y + 20, 55, 15)
	   GUICtrlSetState(-1, $GUI_DISABLE)
	   $g_hRdoArmy3 = GUICtrlCreateRadio(GetTranslated(621, 39, "Army 123 + Don't Empty Barracks"), $x + 245, $y + 20, -1, 15)
	   GUICtrlSetState(-1, $GUI_DISABLE)
